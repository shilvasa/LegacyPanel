function LegacyPanel_InitUI()
	...
	Legacy.UI.Home.Page[LEGACY_PAGE_CLASSSKILL] = LegacyUI_Page0;
	Legacy.UI.Home.Nav[LEGACY_PAGE_CLASSSKILL] = LegacyUI_Nav0;
	Legacy.UI.Home.Page[LEGACY_PAGE_RUNE] = LegacyUI_Page1;
	Legacy.UI.Home.Nav[LEGACY_PAGE_RUNE] = LegacyUI_Nav1;
	Legacy.UI.Home.Page[LEGACY_PAGE_TRANSMOG] = LegacyUI_Page2;
	Legacy.UI.Home.Nav[LEGACY_PAGE_TRANSMOG] = LegacyUI_Nav2;
	Legacy.UI.Home.Page[LEGACY_PAGE_GUILD] = LegacyUI_Page3;
	Legacy.UI.Home.Nav[LEGACY_PAGE_GUILD] = LegacyUI_Nav3;
	Legacy.UI.Home.Page[LEGACY_PAGE_LEGACY] = LegacyUI_Page4;
	Legacy.UI.Home.Nav[LEGACY_PAGE_LEGACY] = LegacyUI_Nav4;
	Legacy.UI.Home.Page[LEGACY_PAGE_MARKET] = LegacyUI_Page5;
	Legacy.UI.Home.Nav[LEGACY_PAGE_MARKET] = LegacyUI_Nav5;
	Legacy.UI.Home.Page[LEGACY_PAGE_REPUTATION] = LegacyUI_Page6;
	Legacy.UI.Home.Nav[LEGACY_PAGE_REPUTATION] = LegacyUI_Nav6;
	Legacy.UI.Home.Page[LEGACY_PAGE_ACTIVATION_KEY] = LegacyUI_Page7;
	Legacy.UI.Home.Nav[LEGACY_PAGE_ACTIVATION_KEY] = LegacyUI_Nav7;
	...
	Legacy.UI.Transmog.Frame = LegacyUI_TransmogFrame;
	Legacy.UI.Transmog.SlotFrame = LegacyUI_TransmogSlotFrame;
	Legacy.UI.Transmog.CollFrame = LegacyUI_TransmogCollFrame;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_HEAD] = LegacyUI_Transmog1;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_SHOULDERS] = LegacyUI_Transmog2;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_SHIRT] = LegacyUI_Transmog3;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_CHEST] = LegacyUI_Transmog4;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_WAIST] = LegacyUI_Transmog5;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_LEGS] = LegacyUI_Transmog6;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_FEET] = LegacyUI_Transmog7;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_WRIST] = LegacyUI_Transmog8;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_HANDS] = LegacyUI_Transmog9;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_BACK] = LegacyUI_Transmog10;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_MAINHAND] = LegacyUI_Transmog11;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_OFFHAND] = LegacyUI_Transmog12;
	Legacy.UI.Transmog.EquipSlot[LEGACY_EQUIP_SLOT_RANGED] = LegacyUI_Transmog13;
	for i = 0, LEGACY_MAX_TRANSMOG_TYPE_SLOT do
		Legacy.UI.Transmog.Slot[i] = _G["LegacyUI_TransmogSlot"..i];
	end
	for i = 0, LEGACY_MAX_TRANSMOG_COLL_SLOT do
		Legacy.UI.Transmog.Coll[i] = _G["LegacyUI_TransmogCollection"..i];
	end
	
	Legacy.UI.Transmog.Nav.Coll[LEGACY_NAV_PREV] = LegacyUI_TransmogCollectionNavLeft;
	Legacy.UI.Transmog.Nav.Coll[LEGACY_NAV_NEXT] = LegacyUI_TransmogCollectionNavRight;
