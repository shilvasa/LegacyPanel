...
StaticPopupDialogs["LEGACY_REMOVE_RUNE_CONFIRM"] =
{
    ...
    button2 = LEGACY_CANCEL,
    OnAccept = function(self)
        Legacy_DoQuery(LMSG_A_REMOVE_RUNE, self.type..":"..self.slot);
    end,
    OnCancel = function() end,
    timeout = 0,
    exclusive = 1,
...
StaticPopupDialogs["LEGACY_RESET_MASTERY_CONFIRM"] =
{
    text = LEGACY_RESET_MASTERY_CONFIRM,
    button1 = LEGACY_CONFIRM,
    button2 = LEGACY_CANCEL,
    OnAccept = function(self)
        Legacy_DoQuery(LMSG_A_RESET_STATS);
    end,
    OnCancel = function() end,
    timeout = 0,
    exclusive = 1,
