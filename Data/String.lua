...
{
    [1] = { Title = "武力", Tip = "武力 |cffffffff%d|r", Bonus = "|cff00ff00+%.2f%%|r |cffffffff武器精准率|r", Desc = "|cff00ff00+%.2f%%|r |cffffffff力量属性增益|r|n|cff00ff00+%.2f%%|r |cffffffff耐力属性增益|r|n|cff00ff00+%.2f%%|r |cffffffff敏捷属性增益|r|n|cffff0000-%.2f%%|r |cffffffff智力属性增益|r|n|cffff0000-%.2f%%|r |cffffffff精神属性增益|r", Icon = "Interface\\Icons\\ABILITY_WARRIOR_STRENGTHOFARMS" },
    [2] = { Title = "直觉", Tip = "直觉 |cffffffff%d|r", Bonus = "|cff00ff00+%.2f%%|r |cffffffff武器爆击率|r", Desc = "|cff00ff00+%.2f%%|r |cffffffff敏捷属性增益|r|n|cff00ff00+%.2f%%|r |cffffffff力量属性增益|r|n|cff00ff00+%.2f%%|r |cffffffff智力属性增益|r|n|cffff0000-%.2f%%|r |cffffffff精神属性增益|r|n|cffff0000-%.2f%%|r |cffffffff耐力属性增益|r", Icon = "Interface\\Icons\\ABILITY_ROGUE_MASTEROFSUBTLETY" },
...
LEGACY_NAV_DATA = 
{
	...
	[5] = { Name = "市场", Desc = "一些可以悄悄买到的宝贝",  Icon = "Interface\\Icons\\INV_MISC_COINBAG_SPECIAL" },
    [6] = { Name = "声望", Desc = "你的社区贡献和奖励", Icon = "Interface\\Icons\\ABILITY_PALADIN_VENERATION" },
	[7] = { Name = "XOR", Desc = "拥有神秘力量的符记", Icon = "Interface\\Icons\\INV_MISC_CODEXOFXERRATH_CHAINS" },
};
...
LEGACY_MARKET_PRICE = "|cffffffff价格|r";
...
LEGACY_CLICK_TO_EXPAND = "|cff00ff00点击展开 (%d项)|r";
...
LEGACY_STAT_NAME = 
{
	...
	[LEGACY_STAT_POWER_MELEE] = { n = "近战攻击强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_MELEE" },
	[LEGACY_STAT_POWER_RANGED] = { n = "远程攻击强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_RANGED" },
	[LEGACY_STAT_POWER_HOLY] = { n = "神圣法术强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_HOLY" },
	[LEGACY_STAT_POWER_FIRE] = { n = "火焰法术强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_FIRE" },
	[LEGACY_STAT_POWER_NATURE] = { n = "自然法术强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_NATURE" },
	[LEGACY_STAT_POWER_FROST] = { n = "冰霜法术强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_FROST" },
	[LEGACY_STAT_POWER_SHADOW] = { n = "暗影法术强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_SHADOW" },
	[LEGACY_STAT_POWER_ARCANE] = { n = "奥术法术强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_ARCANE" },
	[LEGACY_STAT_POWER_HEALING] = { n = "治疗法术强度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\POWER_HEALING" },
	[LEGACY_STAT_ARMOR] = { n = "护甲", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\ARMOR" },
	[LEGACY_STAT_RES_HOLY] = { n = "神圣抗性", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\RES_HOLY" },
	[LEGACY_STAT_RES_FIRE] = { n = "火焰抗性", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\RES_FIRE" },
	[LEGACY_STAT_RES_NATURE] = { n = "自然抗性", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\RES_NATURE" },
	[LEGACY_STAT_RES_FROST] = { n = "冰霜抗性", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\RES_FROST" },
	[LEGACY_STAT_RES_SHADOW] = { n = "暗影抗性", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\RES_SHADOW" },
	[LEGACY_STAT_RES_ARCANE] = { n = "奥术抗性", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\RES_ARCANE" },
	[LEGACY_STAT_WEAPON_DAMAGE_BASE] = { n = "主手武器伤害", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\MELEE_BASE" },
	[LEGACY_STAT_WEAPON_DAMAGE_OFF] = { n = "副手武器伤害", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\MELEE_OFF" },
	[LEGACY_STAT_WEAPON_DAMAGE_RANGED] = { n = "远程武器伤害", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\RANGED" },
	[LEGACY_STAT_WEAPON_SPEED_BASE] = { n = "主手武器速度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\SPEED_MELEE_BASE" },
	[LEGACY_STAT_WEAPON_SPEED_OFF] = { n = "副手武器速度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\SPEED_MELEE_OFF" },
	[LEGACY_STAT_WEAPON_SPEED_RANGED] = { n = "远程武器速度", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\SPEED_RANGED" },
	[LEGACY_STAT_MANA_REGEN] = { n = "法力恢复速率", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN" },
	[LEGACY_RATING_1] = { n = "韧性等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r异常状态抵抗几率 (对抗%d级敌人)" },
	[LEGACY_RATING_2] = { n = "武器爆击等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r武器攻击爆击率 (对抗%d级敌人)" },
	[LEGACY_RATING_3] = { n = "法术爆击等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r法术攻击爆击率 (对抗%d级敌人)" },
	[LEGACY_RATING_4] = { n = "武器命中等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r武器攻击命中率 (对抗%d级敌人)" },
	[LEGACY_RATING_5] = { n = "法术命中等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r法术攻击命中率 (对抗%d级敌人)" },
	[LEGACY_RATING_6] = { n = "躲闪等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r躲闪几率 (对抗%d级敌人)" },
	[LEGACY_RATING_7] = { n = "招架等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r招架几率 (对抗%d级敌人)" },
	[LEGACY_RATING_8] = { n = "格挡等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r格挡几率 (对抗%d级敌人)" },
	[LEGACY_RATING_9] = { n = "抗魔等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r负面魔法抵抗几率 (对抗%d级敌人)" },
	[LEGACY_RATING_10] = { n = "武器精准等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00-%.2f%%|r武器攻击被招架/躲闪/格挡几率 (对抗%d级敌人)" },
	[LEGACY_RATING_11] = { n = "法术精准等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00-%.2f%%|r法术攻击被抵抗几率 (对抗%d级敌人)" },
	[LEGACY_RATING_12] = { n = "武器爆伤等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r武器爆击伤害 (对抗%d级敌人)" },
	[LEGACY_RATING_13] = { n = "法术爆伤等级", i = "Interface\\Addons\\LegacyPanel\\Asset\\Image\\Icon\\STAT_MANAREGEN", d = "|cff00ff00+%.2f%%|r法术爆击伤害 (对抗%d级敌人)" },
};
...
LEGACY_SKILL_NAME =
{
	...
	[7] = { Name = "元素", Icon = "Interface\\Icons\\SHAMAN_TALENT_ELEMENTALBLAST", Class = "SHAMAN", Shade = "605DD2" },
	[8] = { Name = "增强", Icon = "Interface\\Icons\\SPELL_SHAMAN_MAELSTROMWEAPON", Class = "SHAMAN", Shade = "3632B7" },
	[9] = { Name = "先祖", Icon = "Interface\\Icons\\ABILITY_SHAMAN_ANCESTRALGUIDANCE", Class = "SHAMAN", Shade = "00AC87" },
